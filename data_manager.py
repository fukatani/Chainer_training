...
class data_manager(object):
    ...
    def data_split(self):
        split_result_dir = self.directory + '/split_result/'
    ...
    def __init__(self, directory, data_size=10000, split_flag=False):
        self.directory = directory
        self.data_size= data_size
        self.split_flag = split_flag

if __name__ == '__main__':
    data_manager('C:/Users/rf/Documents/github/Chainer_training/numbers', 2000, True).plot()